 ...
 * The subclasses will provide the sort and reverse methods.
 */
...
public abstract class AbstractSorter implements Sorter {
	 ...
	 *
	 */
	public void sort(long[] a) 						{ sort(a,0,a.length); }
	/**
	 *
	 * @param a is the float array to be sorted in an ascending order
	 *
	 */
	public void sort(float[] a) 					{ sort(a,0,a.length); }
	/**
	 *
	 * @param a is the double array to be sorted in an ascending order
	 *
	 */
	public void sort(double[] a)					{ sort(a,0,a.length); }
	/**
	 *
	 * @param a is the byte array to be sorted in a descending order
	 *
	 */
	public void reverse(byte[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the character array to be sorted in a descending order
	 *
	 */
	public void reverse(char[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the short array to be sorted in a descending order
	 *
	 */
	public void reverse(short[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the int array to be sorted in a descending order
	 *
	 */
	public void reverse(int[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the long array to be sorted in a descending order
	 *
	 */
	public void reverse(long[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the float array to be sorted in a descending order
	 *
	 */
	public void reverse(float[] a) 					{ reverse(a,0,a.length); }
	/**
	 *
	 * @param a is the double array to be sorted in a descending order
	 *
	 */
	public void reverse(double[] a)					{ reverse(a,0,a.length); }

	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void sort(T[] a) 					{ sort(a,0,a.length); }

	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void sort(T[] a, Comparator<T> c)	{ sort(a,0,a.length,c); }

	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void reverse(T[] a) 				{ reverse(a,0,a.length); }

	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void sort(List<T> a) 					{ sort(a,0,a.size()); }

	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void sort(List<T> a, Comparator<T> c) 	{ sort(a,0,a.size(),c); }
	/** 
	 * {@inheritDoc}
	 */
	public <T extends Comparable<T>> void reverse(List<T> a) 				{ reverse(a,0,a.size()); }
