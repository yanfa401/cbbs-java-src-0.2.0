...
/**
 * <p><b>Interface Sorter</b></p>
 *
 * <p>An interface provided by various sorting classes.</p>
 *
 * <p>Interface methods operate on arrays and List collections.  Element types for arrays
 * may be builtin types or objects</p>
 *
...
public interface Sorter {
	/**
	 *
	 * @param a array upon which to operate.
	 ...
	 *
	 * @param a array upon which to operate.
	 * @param from starting array index starting array index
	 * @param to ending array index
	 ...
	 * @param a array upon which to operate.
	 * @param from starting array index starting array index
	 * @param to ending array index ending array index
	 */
	 ...
	 * @param a array upon which to operate.
	 * @param from starting array index
	 * @param to ending array index
	 */
	 ...
	 * @param <T> data type
	 * @param a array upon which to operate.
	 * @param c comparator used to do comparison
