...
public class QuickSorter extends DefaultSorter {
	protected final static int IS_THRESHOLD = 64;
	private final static int PIVOT_ALG = 3;
	 ...
	 *
	 * @param data is byte array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is charater array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is short array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is int array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is long array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is float array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * <b> Routine to find pivot element. </b>
	 *
	 * @param data is double array to be sorted
	 * @param ax is the first index
	 * @param bx is the mid index
	 * @param cx is the last index
	 * @return the median number
	 ...
	 * @param mid is the mid index
	 * @param last is the last index
	 * @return the median number
	 */
	...
	protected static int ninther (int[] data, int first, int mid, int last) {
		...
		return median (data,
					   median(data,first,first+s,first+s*2),
					   median(data,mid-s,mid,mid+s),
					   median(data,last-2*s,last-s,last));
	}
	...
	protected int selectPivot (int[] a, int fromIndex, int toIndex) {
		...
		switch (PIVOT_ALG) {
			...
			// (4) Compute the "ninther" - the median of the median of three samples of
			//     elements chosen uniformly from the array.
			case 4:
				return ninther(a, first, mid, last);

			// (5) Choose dynamically among algorithms 1, 3 and 4 (following the technique
			// in Bentley & McIlroy, "Engineering a sort function"
			case 5:
				if (size > 100) {
					if (size > 1000) return ninther(a, first, mid, last);
					else return median(a, first, mid, last);
				} else return mid;
